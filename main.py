...
oracle_samples_path = './new_samples'
oracle_state_dict_path = './oracle_EMBDIM32_HIDDENDIM32_VOCAB5000_MAXSEQLEN20.trc'
pretrained_gen_path = './gen_MLEtrain_EMBDIM32_HIDDENDIM32_VOCAB5000_MAXSEQLEN20.trc'
trained_gen_path = './final.trc'
...
if __name__ == '__main__':
    ...
    train_generator_MLE(gen, gen_optimizer, None, oracle_samples, MLE_TRAIN_EPOCHS)
    ...
    train_discriminator(dis, dis_optimizer, oracle_samples, gen, oracle_sample, DIS_PRETRAIN_EPOCHS, 3)
    ...
    for epoch in range(ADV_TRAIN_EPOCHS):
        ...
        sys.stdout.flush()
        train_generator_PG(gen, gen_optimizer, None, dis, 1)
        ...
        train_discriminator(dis, dis_optimizer, oracle_samples, gen, oracle_sample, 1, 3)

    torch.save(gen.state_dict(), trained_gen_path)
    # gen.load_state_dict(torch.load(trained_gen_path))
